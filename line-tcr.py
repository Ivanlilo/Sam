...
ki = LINETCR.LINE()
ki.login(token="EmxTpY12bXcEy9Wv47e6.wUhUiXffKI2berC7u/cRPG.ZMO9pCpShYyN+D9bQTpawOTPZwcnst2WL6LuNHzjU0g=")

kk = LINETCR.LINE()
kk.login(token="Em2fjRQ6rmRccryHn303.FOy2rxd/Edc7gSRWIKGGyW.CG6PJGz94SSOYqeeglRnj1VtrZasxlgdeWVMvXmGcSA=")

kc = LINETCR.LINE()
kc.login(token="Emc81JWjDMlCwutjlHX6.eabObmOUAG3sc99TwWHzPG.hUjbk5Vi8QDgwB8hRA7qgcJDsvtt/KNUyMMHIfzQnQY=")

ks = LINETCR.LINE()
ks.login(token="EmWCU0xwV2vqVp5eNyHd.0YIV9iuinkUDQdFmOIjOBq.lc7sx25MYiS7yPislPeQyU/p1MYZECm286XBJ33b0X8=")
...
helpMessage =""" [Sky.NET] Menu  􀔃􀄆red check mark􏿿
...
Setgroup =""" Private 􀔃􀄆red check mark􏿿
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,"u75d0da4058db4d1da2b4bd7bd0cd704c"]
admin = ["u0bc30da8b74147d35b5748327300abf4","u75d0da4058db4d1da2b4bd7bd0cd704c","u7e86364570fe7830bb1acaf08a482063"]
staff = ["u0bc30da8b74147d35b5748327300abf4","u75d0da4058db4d1da2b4bd7bd0cd704c","u7e86364570fe7830bb1acaf08a482063"]
adminMID = ["u0bc30da8b74147d35b5748327300abf4"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Sini gan","Kuy join","Masuk uy"]:
              if msg.from_ in admin:
